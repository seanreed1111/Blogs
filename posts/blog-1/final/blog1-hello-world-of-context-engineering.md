...
Here is how I think about it. You are now the engineering manager of a fleet of tiny people living inside your computer. They can do astonishingly complex tasks. They can also wreck your life, and the lives of your coworkers, and the existence of your production database. If you have ever seen *The Squire of Gothos* --- the Star Trek TOS episode where Trelane has godlike power but turns out to be a child just looking to play --- that is the dynamic. Immense capability, no judgment. The judgment has to come from you.
...
## The Future: What This Blog Will Cover
